<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav">
            ...
            <li><a href="<?php echo $this->buildUrl('Tag','tags')?>">标签</a></li>
        </ul>
        <form class="navbar-form navbar-left" role="search" action="<?php echo $this->buildUrl('Search','index')?>" method="post">
            ...
            <?php if(isset($_SESSION['user'])){ ?>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo $this->buildUrl('Post','add') ?>">Post</a></li>
                    </ul>
                </li>
                <li><a href="<?php echo $this->buildUrl('Post','add') ?>"><span class="glyphicon glyphicon-plus">撰写</span></a></li>
            <?php } ?>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <?php if(empty($_SESSION['user'])){ ?>
                        <li><a href="<?php echo $this->buildUrl('Index','login') ?>"> 登录</a></li>
                        <li><a href="<?php echo $this->buildUrl('Index','reg') ?>"> 注册</a></li>
                    <?php } ?>
                    <?php if(isset($_SESSION['user'])){ ?>
                        <li>
                            <a href="<?php echo $this->buildUrl('User','index',$_SESSION['user']['username']) ?>">
                                <span class="glyphicon glyphicon-home"> 我的主页</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo $this->buildUrl('User','user') ?>">
