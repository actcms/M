<div id="post">
    ...
    <form action="<?php $this->w(\M\App::buildUrl('Post','update')) ?>" method="post" id="add-post">
        ...
        <div class="row">
            <div class="col-md-8">
                <input type="text" name="tags" class="form-control" value="<?php $this->w($post['tags'])?>" placeholder="标签之间请用英文','隔开">
            </div>
            <div class="col-md-4">
                <label class="checkbox-inline">
                    <input type="checkbox" name="top" value="1" <?php $this->w($post['top']?'checked':'')?>> 置顶
                </label>
            </div>
        </div>
